...
namespace Color_yr.Minecraft_QQ
{
    class config_read
    {
        ...
        public static Thread config_thread = new Thread(read_config);
        ...
        public static void read_config()
        {
            ...
            if (XML.read(Event, "更新？") != "false")
            {
                ...
                if (XML.read(Event, "事件-文件上传") == null) XML.write(Event, "事件-文件上传", "%player%上传了文件%file%");
                ...
                if (XML.read(Event, "启用群内绑定") == null) XML.write(Event, "启用群内绑定", "启用");
            }
            ...
            if (check == null) { MessageBox.Show("未设置群号，请设置"); frm.ShowDialog(); }
